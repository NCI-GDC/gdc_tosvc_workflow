...
steps:
  - id: get_readlen
    run: ../tools/get_readlen.cwl
    in:
      bam: tumor_bam
    out: [readlen]

  - id: gem_mappability
    run: ../tools/gem-mappability.cwl
    in:
      indexfile: gem_index
  ...
  - id: extract_wig_size
    run: ../tools/extract_wig_size.cwl
    in:
